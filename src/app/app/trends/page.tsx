...
import { TREND_REGIONS, TREND_CATEGORIES, TREND_LANGUAGES } from "@/lib/trends-constants";
          ...
          {results.map((v, i) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">{v.channelTitle}</p>
